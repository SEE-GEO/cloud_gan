...
if path.exists('rr_modis_cloudsat_data_2016_3435.h5'):
    hf = h5py.File('./rr_modis_cloudsat_data_2016_3435.h5','r')
...
for ind in range(3436, len(files_cloudsat)):
    ...
    print(testing_cs)
    testing_modis = files_modis[ind+displacement].start_time
    print(testing_modis)
    while first or (increased or decreased):
        ...
        if delta_start < 0 and not increased:
            ...
            decreased = True
            print('decreased')
        elif delta_start > time_for_one_rotation/3.5 and not decreased:
            displacement = displacement + 1
            increased= True
            print('increased')
        else:
    ...
    print(len(latitudes), 'length of modis latitudes')
    ...
    if n < 37082:
        ...
        filename = 'rr_modis_cloudsat_data_2016' + '_' + str(ind).zfill(4) + '.h5'

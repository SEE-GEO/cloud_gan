...
pcm1 = ax1.pcolormesh(x_ocean, y_ocean, new_total)
...
cb1=f1.colorbar(pcm1,ax=ax1, orientation = 'horizontal', fraction =0.049, pad=0.15, format=ticker.FuncFormatter(fmt))
cb1.set_label('Norm. occurrence (Real) $10^{-4}$ [dBZ$^{-1}$]', fontsize=28)
...
pcm2 = ax2.pcolormesh(x_land, y_land, new_total_generated)
...
cb2=f2.colorbar(pcm2,ax=ax2, orientation = 'horizontal', fraction =0.049, pad=0.15, format=ticker.FuncFormatter(fmt))
cb2.set_label('Norm. occurrence (Generated) $10^{-4}$ [dBZ$^{-1}$]', fontsize=28)
...
pcm3 = ax3.pcolormesh(x_diff, y_diff, occurence_diff,vmin = -0.00021, vmax = 0.00021,cmap= 'seismic')
...
cb3=f3.colorbar(pcm3,ax=ax3, orientation = 'horizontal', fraction =0.049, pad=0.15, format=ticker.FuncFormatter(fmt))
cb3.set_label('Occurence bias (Real - Gen.) $10^{-4}$ [dBZ$^{-1}$]', fontsize=28)
...
cb4.set_label('Occurence bias (Real - Generated)/Real', fontsize=28)

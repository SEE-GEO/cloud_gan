...
ax1.set_title('Ocean')
cb1=f1.colorbar(pcm1,ax=ax1, orientation = 'horizontal', fraction =0.049, pad=0.2)
cb1.set_label('Norm. occurrence')
plt.savefig('Ocean_histogram_GAN')
...
ax2.set_title('Land')
cb2=f2.colorbar(pcm2,ax=ax2, orientation = 'horizontal', fraction =0.049, pad=0.2)
cb2.set_label('Norm. occurrence')
plt.savefig('Land_histogram_GAN')
#plt.show()
...
cb3=f3.colorbar(pcm3,ax=ax3, orientation = 'horizontal', fraction =0.049, pad=0.2)
cb3.set_label('Occurence bias (ocean - land)')
plt.savefig('Difference_histogram_GAN')
